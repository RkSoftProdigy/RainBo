...
- (id)initWithFrame:(CGRect)frame {
	...
	if (self) {
		...
		self.animationType = MBProgressHUDModeIndeterminate;
...
- (void)updateIndicators {
	...
	BOOL isActivityIndicator = [indicator isKindOfClass:[DGActivityIndicatorView class]];
	BOOL isRoundIndicator = [indicator isKindOfClass:[MBRoundProgressView class]];
	
	if (mode == MBProgressHUDModeIndeterminate &&  !isActivityIndicator) {
		// Update to indeterminate indicator
		[indicator removeFromSuperview];
        self.indicator = MB_AUTORELEASE([[DGActivityIndicatorView alloc] initWithType:DGActivityIndicatorAnimationTypeBallClipRotate tintColor:[UIColor colorWithRed:2.0/255.0 green:155.0/255.0 blue:199.0/255.0 alpha:1.0] size:30.0f]);
		[(DGActivityIndicatorView *)indicator startAnimating];
